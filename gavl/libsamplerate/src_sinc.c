...
static void prepare_data_f (SINC_FILTER *filter, SRC_DATA *data, int half_filter_chan_len) ;
static void prepare_data_d (SINC_FILTER *filter, SRC_DATA *data, int half_filter_chan_len) ;
